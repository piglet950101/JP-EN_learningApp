"""
Parse 「直し 8. 26.docx」 (client review, 2026-08-19) into
...
Output: tool/corrections_0826.json
    {
      "source": "...docx",
      "word_count": N,
      "records": [
...
SRC = ROOT / '直し 8. 26.docx'
OUT = Path(__file__).with_name('corrections_0826.json')
...
def parse() -> dict:
    ...
    for raw in lines:
        ...
        if t in ('First Stage', 'Second Stage'):
            stage = t
            continue
