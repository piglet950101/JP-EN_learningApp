"""
Parse 「アプリ直し 8. 31.docx」 (client review, 2026-08-19) into
...
Output: tool/corrections_0831.json
    {
      "source": "...docx",
      "word_count": N,
      "records": [
...
SRC = ROOT / 'アプリ直し 8. 31.docx'
OUT = Path(__file__).with_name('corrections_0831.json')
